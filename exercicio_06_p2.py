...
#11 - Modifique a classe Agenda para incluir um método chamado buscar_contato, 
# que recebe o nome de um contato como parâmetro e retorna o objeto Contato correspondente, 
# dentre os contatos do atributo contatos. 
# Ou, se o contato não existir, retornar None.
#12 - Adicione ao menu na função main a opção de Buscar contato. Utilize o método
#buscar contato da agenda.
