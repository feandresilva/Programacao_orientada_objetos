#15 - Modifique a classe Agenda para incluir um método chamado remover_contato, 
# que recebe o nome de um contato como parâmetro e remove o objeto Contato correspondente, 
# dentre os contatos do atributo contatos. 
#16 - Adicione ao menu na função main a opção de Remover contato da agenda. Utilize o método
